...
| Web matching             | Resized metadata-stripped provider copy, public URLs and provider match evidence                                                                       | Surface candidate copies                        | Contract/legitimate interests — balancing test required                         | TinEye when commercial account is activated            | Matches/cases per retention policy             |
